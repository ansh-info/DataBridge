#!/usr/bin/env python3
"""
Static pipeline for the S&P 500 stock dataset.

Downloads the latest S&P 500 dataset from Kaggle,
...
def run_pipeline():
    """
    Main entrypoint for the S&P 500 static data pipeline.
    """
    ...
    print("[INFO] Preview of loaded S&P 500 data:")
    df.show(5)
    df.printSchema()

    # 3. Write DataFrame to BigQuery
    table_name = "sandp500_data"
...
if __name__ == "__main__":
    print(f"[INFO] Starting S&P 500 static pipeline at {datetime.now()}")
    run_pipeline()