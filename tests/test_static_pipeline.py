#!/usr/bin/env python3
"""
Test for the static data pipeline: verifies CSV loading and BigQuery write.
"""
import os
import sys
import tempfile
...
temp_dir = tempfile.mkdtemp(prefix='static_test_')
try:
    # Create sample data
    sample = pd.DataFrame([
        {"col1": 1, "col2": "foo"},
    ...
    print("[INFO] Preview of loaded DataFrame:")
    df.show()
    df.printSchema()

    # Step 4: Write to BigQuery
    table_name = "static_test_data"
